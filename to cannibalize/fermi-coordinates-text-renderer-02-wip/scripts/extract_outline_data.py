#!/usr/bin/env python3
"""Generate shaped glyph outline data for mesh text overlays."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Shape text and flatten font outlines into the JS format used by the mesh text overlay."
    )
    parser.add_argument(
        "--font",
        type=Path,
