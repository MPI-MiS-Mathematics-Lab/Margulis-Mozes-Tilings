...
// Uses the AlphaEvolve digit-counting algorithm:
//   color = (h + count_of_odd_digits_in_base_m(l) - final_l) mod 3
...
// 3-coloring via base-m digit decomposition (m must be odd)
